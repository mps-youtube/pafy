...
class g(object):
    ...
    itags = {
        ...
        '171': ('128k', 'ogg', 'audio', ''),
        '172': ('192k', 'ogg', 'audio', ''),
        '242': ('360x240', 'webm', 'video', ''),
        '243': ('480x360', 'webm', 'video', ''),
        '244': ('640x480', 'webm', 'video', ''),
        '245': ('640x480', 'webm', 'video', ''),
        '246': ('640x480', 'webm', 'video', ''),
        '247': ('720x480', 'webm', 'video', ''),
        '248': ('1920x1080', 'webm', 'video', ''),
...
def get_js_sm(video_id):
    ...
    if re.search(r'player-age-gate-content">', watchinfo) is not None:
        ...
        doppleganger._fetch_basic(ageurl=video_info_url)
...
class Pafy(object):
    ...
    def _fetch_basic(self, ageurl=None):
